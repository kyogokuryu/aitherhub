...
"""
STEP 6.5 – Audio Paralinguistic Feature Extraction (Filtered)
...
def analyze_phase_audio_features(
    ...
    for phase in phase_units:
        if not should_analyze_phase(phase):
        ...
        try:
            ...
            phase["audio_features"] = features
            analyzed += 1

            print(
                f"[AUDIO-FEATURES] Phase {phase.get('phase_index')}: "
